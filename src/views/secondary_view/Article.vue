  ...
  <div class="parent-div">
    ...
    <el-row>
      ...
      <el-col :span="3" :offset="13">
        <el-button size="medium" type="primary" plain><i class="el-icon-plus"></i></el-button>
        <el-button size="medium" type="primary" plain><i class="el-icon-refresh-right"></i></el-button>
    ...
    <el-row>
      ...
      <el-table-column sortable label="最后一次编辑" prop="date" width="150"></el-table-column>
      ...
      <el-table-column sortable prop="status" label="状态" width="100">
        <template slot-scope="scope">
          <el-tag size="medium" :type="scope.row.status === '1' ? 'primary' : 'info'" disable-transitions>{{scope.row.status === 1 ? '已发布':'草稿'}}</el-tag>
        </template>
      </el-table-column>
